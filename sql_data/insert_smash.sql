...
insert into smash values('Single',994,'Kirby','Mr. Game & Watch','Eroe','Ragazza Inkling','Sandro');
insert into smash values('Single',993,'Kirby','Lucario','Eroe','Wario','Ale');
insert into smash values('Single',992,'Kirby','Palutena','Eroe','Lucas','Ale');
insert into smash values('Single',991,'Kirby','Daisy','Eroe','Sora','Siwei');
insert into smash values('Single',990,'Kirby','Mewtwo','Eroe','Samus','Ale');
insert into smash values('Single',989,'Kirby','Samus Tuta Zero','Eroe','Shulk','Ale');
insert into smash values('Single',988,'Jigglypuff','Zelda','Eroe','Pit','Leo');
insert into smash values('Single',987,'Sonic','Link Cartone','Eroe','Ryu','Leo');
insert into smash values('Single',986,'Pikachu','Kazuya','Eroe','Diddy Kong','Sandro');
insert into smash values('Single',985,'Sheik','Incineroar','Eroe','Diddy Kong','Ale');
insert into smash values('Single',984,'Pac-Man','Mega Man','Eroe','Little Mac','Ale');
insert into smash values('Single',983,'Kazuya','Sephiroth','Eroe','Lottatore Mii','Leo');
insert into smash values('Single',982,'Pyra & Mythra','Kirby','Eroe','Spadaccino Mii','Ale');
insert into smash values('Single',981,'Pyra & Mythra','Ganondorf','Eroe','Pit Oscuro','Leo');
insert into smash values('Single',980,'Pyra & Mythra','Steve','Eroe','Banjo e Kazooie','Ale');
insert into smash values('Single',979,'Pyra & Mythra','Pokemon Trainer','Eroe','Cloud','Ale');
insert into smash values('Single',978,'Kirby','Joker','Eroe','Banjo e Kazooie','Ale');
insert into smash values('Single',977,'Kirby','Joker','Eroe','King K. Rool','Ale');
insert into smash values('Single',976,'Pichu','Incineroar','Eroe','King K. Rool','Leo');
insert into smash values('Single',975,'Joker','Lucina','Eroe','Spadaccino Mii','Leo');
insert into smash values('Single',974,'Pyra & Mythra','Trainer di Wii Fit','Eroe','Spadaccino Mii','Ale');
insert into smash values('Single',973,'Ragazza Inkling','Ken','Eroe','Spadaccino Mii','Ale');
insert into smash values('Single',972,'Kirby','Kazuya','Eroe','Spadaccino Mii','Ale');
insert into smash values('Single',971,'Pyra & Mythra','Byleth','Eroe','R.O.B.','Ale');
insert into smash values('Single',970,'Pyra & Mythra','Byleth','Eroe','Pit Oscuro','Leo');
insert into smash values('Single',969,'Pyra & Mythra','Snake','Eroe','Pit Oscuro','Leo');
insert into smash values('Single',968,'Palutena','Ness','Eroe','Pit','Ale');
insert into smash values('Single',967,'Ness','Palutena','Eroe','Pit Oscuro','Leo');
insert into smash values('Single',966,'Fox','Captain Falcon','Eroe','Ganondorf','Ale');
insert into smash values('Single',965,'Fox','Captain Falcon','Eroe','Pit','Sandro');
insert into smash values('Single',964,'Fox','Rosalinda e Sfavillotto','Eroe','Byleth','Sandro');
insert into smash values('Single',963,'Fox','Ice Climbers','Eroe','Pit','Ale');
insert into smash values('Single',962,'Ganondorf','Bowser','Eroe','Spadaccino Mii','Siwei');
insert into smash values('Single',961,'Meta Knight','Abitante','Sephiroth','Little Mac','Sandro');
insert into smash values('Single',960,'Min Min','Pokemon Trainer','Sephiroth','Little Mac','Siwei');
insert into smash values('Single',959,'Incineroar','Mega Man','Sephiroth','Eroe','Leo');
insert into smash values('Single',958,'Fuffi','Kazuya','Greninja','Cloud','Ale');
insert into smash values('Single',957,'Sora','Kazuya','Bowser','Cloud','Ale');
insert into smash values('Single',956,'Pac-Man','Fuciliere Mii','King Dedede','Cloud','Leo');
insert into smash values('Doubles',414,'Daisy','Jigglypuff','Sheik','Ragazza Inkling','Ale','Siwei');
insert into smash values('Doubles',413,'Chrom','King K. Rool','Banjo e Kazooie','Rosalinda e Sfavillotto','Ale','Leo');
insert into smash values('Doubles',412,'Sora','Abitante','Pikachu','Donkey Kong','Ale','Sandro');
insert into smash values('Doubles',411,'Ganondorf','Wario','Mario','Luigi','Ale','Leo');
insert into smash values('Doubles',410,'Captain Falcon','Roy','Samus Tuta Zero','Marth','Ale','Sandro');
insert into smash values('Doubles',409,'Link Cartone','Ridley','Pit','Diddy Kong','Leo','Sandro');
insert into smash values('Doubles',408,'Greninja','Sonic','Dr. Mario','Eroe','Leo','Sandro');
